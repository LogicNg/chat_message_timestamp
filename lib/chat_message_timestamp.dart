...
import 'package:chat_message_timestamp/extensions/text_painter_extension.dart';
import 'package:chat_message_timestamp/extensions/text_span_extension.dart';
...
class TimestampedChatMessage extends LeafRenderObjectWidget {
  ...
  RenderObject createRenderObject(BuildContext context) {
    ...
    return TimestampedChatMessageRenderObject(
      ...
      sentAtStyle: effectiveTextStyle.copyWith(fontSize: 13).merge(sentAtStyle),
      maxLines: maxLines,
